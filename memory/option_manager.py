...
class OptionManager:
    ...
    def init_index_option_month_strike_num(self):
        ...
        sorted_values = [strike_price_count[key] for key in sorted_keys]
    ...
    def init_index_option_market_data(self):
        ...
        market_data = np.zeros((len(self.index_option_month_forward_id), 2, self.index_option_month_strike_num, 7))
        return market_data
